...
import com.example.eduplanet_e_learningapp.databinding.FragmentOtherProfileDoubtBinding;
...
public class OtherProfileDoubtFragment extends Fragment {
    ...
    public OtherProfileDoubtFragment(String profileId) {
    ...
    FragmentOtherProfileDoubtBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentOtherProfileDoubtBinding.inflate(inflater,container,false);
    ...
    private void fetchDoubts() {
        firestore.collection("Doubt").whereEqualTo("doubtedBy", profileId)
